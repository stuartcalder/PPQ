...
#define SYMM_THREEFISH512_TWEAK_BYTES		(SYMM_THREEFISH512_TWEAK_WORDS * sizeof(uint64_t))
#define SYMM_THREEFISH512_TWEAK_BITS		(SYMM_THREEFISH512_TWEAK_BYTES * CHAR_BIT)
#define SYMM_THREEFISH512_NUMBER_ROUNDS		72
#define SYMM_THREEFISH512_NUMBER_SUBKEYS	((SYMM_THREEFISH512_NUMBER_ROUNDS / 4) + 1)
