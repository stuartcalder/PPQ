...
void Skc_UBI512_chain_config(Skc_UBI512* const R_ ctx, const uint64_t num_out_bits)
{
...
void Skc_UBI512_chain_native_output (Skc_UBI512* const R_ ctx, uint8_t* R_ output) {
...
void Skc_UBI512_chain_message (Skc_UBI512* const R_ ctx, const uint8_t* R_ input, uint64_t num_in_bytes) {
...
void Skc_UBI512_chain_output (Skc_UBI512* const R_ ctx, uint8_t* R_ output, uint64_t num_out_bytes) {
...
void Skc_UBI512_chain_key (Skc_UBI512* const R_ ctx, const uint8_t* R_ input) {
