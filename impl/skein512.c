...
void Skc_Skein512_hash (R_(Skc_UBI512* const) ubi512,
                        uint8_t*              out,
			const uint8_t*        in,
...
void Skc_Skein512_hash_native (R_(Skc_UBI512* const) ubi512,
                               uint8_t*              out,
			       const uint8_t*        in,
			       const uint64_t        num_in)
{
...
void Skc_Skein512_mac (R_(Skc_UBI512* const) ubi512,
                       uint8_t*              out,
		       const uint8_t*        in,
