...
#define SYMM_COMMON_PASSWORD_PROMPT		"Please input a password (max length 120 characters)." SYMM_COMMON_PROMPT
#define SYMM_COMMON_REENTRY_PROMPT		"Please input the same password again." SYMM_COMMON_PROMPT
#define SYMM_COMMON_ENTROPY_PROMPT		"Please input up to 120 random characters." SYMM_COMMON_PROMPT
