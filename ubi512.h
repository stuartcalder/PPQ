...
#define SKC_UBI512_TWEAK_FIRST_BIT	UINT8_C(0b01000000)
#define SKC_UBI512_TWEAK_FIRST_MASK	UINT8_C(0b10111111)
#define SKC_UBI512_TWEAK_LAST_BIT	UINT8_C(0b10000000)
